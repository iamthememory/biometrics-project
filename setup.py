...
"""Setup and/or install Biometrics Thing.
"""
...
setup(
    name='biometricsthing',
    version='0.0.1',
    description='Does a Biometrics thing',
    long_description=long_desc,
    author=authors,
    author_email=authors,
    url='https://github.com/iamthememory/biometrics-project.git',
    package_dir={'biometricsthing': 'biometricsthing'},
    ...
    entry_points={
        'console_scripts': [
                'biometricsthing=biometricsthing.biometricsthing:main', ]
        }
)
